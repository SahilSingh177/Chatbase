        ...
        <div className="p-5">
            ...
            <div className="relative mt-2 rounded-md">
              <div className="flex flex-col gap-2 lg:flex-row ">
                <input
                  ...
                  value=""
                />
                <button className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 dark:bg-zinc-900 dark:text-zinc-50 shadow dark:hover:bg-zinc-800/90 bg-zinc-900 text-zinc-50 hover:bg-zinc-800/90 h-9 px-4 py-2">
                  Fetch links
                </button>
              </div>
          ...
          <div className="mt-16">
            ...
            <div className="my-2 flex justify-end">
              <button
                className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 dark:bg-zinc-100 dark:text-zinc-900 shadow-sm :bg-zinc-100 text-zinc-900 hover:bg-zinc-200 h-9 px-4 py-2 dark:hover:bg-zinc-200"
                type="button"
              >
                Add
              </button>
