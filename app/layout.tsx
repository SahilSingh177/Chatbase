                  ...
                  <div className="flex flex-col align-top lg:flex-row lg:space-x-8 lg:align-middle">
                    <div className="m-auto w-full lg:my-0">
                      <div className="  rounded border p-4">
                        ...
                        <button
                          className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 dark:bg-zinc-900 dark:text-zinc-50 shadow dark:hover:bg-zinc-800/90 bg-zinc-50 text-zinc-900 hover:bg-zinc-50/90 h-9 px-4 py-2 mt-4 w-full"
                          type="submit"
                        >
                          Create Chatbot
                        </button>
