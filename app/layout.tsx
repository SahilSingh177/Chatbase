                        ...
                        <ul role="list" className="flex flex-1 flex-col">
                          <li>
                            <ul role="list" className="space-y-1">
                              ...
                              <li>
                                <button
                                  className={`group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6 ${path==="/notion"?"bg-gray-50 text-violet-600":"text-gray-700 hover:bg-gray-50 hover:text-violet-600"}`}
                                  onClick={() => router.push("/notion")}
                                >
                                  <svg
                                    viewBox="13.38 3.2 485.44 505.7"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className={` h-6 w-6 shrink-0 ${path==="/notion"?"fill-violet-600 text-violet-600":"fill-gray-400 group-hover:fill-violet-600"}`}
                                    fill="white"
                                  >
