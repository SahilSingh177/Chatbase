          ...
          <div>
            <div className="max-w-7xl px-4 lg:mx-auto">
              <div
                ...
                style={{
                  gridTemplateColumns: "0.15fr 0.6fr 0.26fr",
                }}
              >
                {/* grid-col-1 */}
                <div
                  className="max-w-xl lg:w-4/6"
                  style={{ width: "100%" }}
                >
                  <div>
                    <div className="md:hidden">
                      <nav className="" data-headlessui-state="">
                          ...
                          <div className="relative flex h-6 items-center justify-end sm:hidden">
                            <div className="left-100 absolute inset-y-0 flex items-center sm:hidden">
                              <button
                                ...
                                id="headlessui-disclosure-button-:Rall6:"
                                type="button"
                                aria-expanded="false"
                        ...
                        <ul role="list" className="flex flex-1 flex-col">
                          <li>
                            <ul role="list" className="space-y-1">
                              <li>
                                <button className={`group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6  ${path==="/files"?"bg-gray-50 text-violet-600":"text-gray-700 hover:bg-gray-50 hover:text-violet-600"}`}
                                ...
                                >
                                  <svg
                                    ...
                                    stroke="currentColor"
                                    aria-hidden="true"
                                    className={`h-6 w-6 shrink-0 ${path==="/files"?"text-violet-600 text-violet-600":"text-gray-400 group-hover:text-violet-600"}`}
                                  >
                                    <path
                                      stroke-linecap="round"
                                      stroke-linejoin="round"
                              ...
                              <li>
                                <button className={`group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6 ${path==="/text"?"bg-gray-50 text-violet-600":"text-gray-700 hover:bg-gray-50 hover:text-violet-600"}`}
                                ...
                                >
                                  <svg
                                    ...
                                    stroke="currentColor"
                                    aria-hidden="true"
                                    className={`h-6 w-6 shrink-0  ${path==="/text"?"text-violet-600 fill-violet-600":"text-gray-400 group-hover:text-violet-600"}`}
                                  >
                                    <path
                                      stroke-linecap="round"
                                      stroke-linejoin="round"
                              ...
                              <li>
                                <button className={`group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6 ${path==="/website"?"bg-gray-50 text-violet-600":"text-gray-700 hover:bg-gray-50 hover:text-violet-600"}`}
                                ...
                                >
                                  <svg
                                    ...
                                    stroke="currentColor"
                                    aria-hidden="true"
                                    className={`h-6 w-6 shrink-0 ${path==="/website"?"text-violet-600 text-violet-600":"text-gray-400 group-hover:text-violet-600"}`}
                                  >
                                    <path
                                      stroke-linecap="round"
                                      stroke-linejoin="round"
                              ...
                              <li>
                                <button
                                  className={`group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6 ${path==="/qna"?"bg-gray-50 text-violet-600":"text-gray-700 hover:bg-gray-50 hover:text-violet-600"}`}
                                ...
                                >
                                  <svg
                                    ...
                                    stroke="currentColor"
                                    aria-hidden="true"
                                    className={`h-6 w-6 shrink-0 ${path==="/qna"?"text-violet-600 text-violet-600":"text-gray-400 group-hover:text-violet-600"}`}
                                  >
                                    <path
                                      stroke-linecap="round"
                                      stroke-linejoin="round"
                              ...
                              <li>
                                <button
                                  className={`group flex w-full gap-x-3 whitespace-nowrap rounded-md p-2 text-sm font-semibold  leading-6 ${path==="/notion" || path==="/"?"bg-gray-50 text-violet-600":"text-gray-700 hover:bg-gray-50 hover:text-violet-600"}`}
                                  onClick={() => router.push("/notion")}
                                >
                                  <svg
                                    viewBox="13.38 3.2 485.44 505.7"
                                    xmlns="http://www.w3.org/2000/svg"
                                    className={` h-6 w-6 shrink-0 ${path==="/notion" || path==="/"?"fill-violet-600 text-violet-600":"fill-gray-400 group-hover:fill-violet-600"}`}
                                    fill="white"
                                  >
                ...
                <div className="">
                  <div className="flex flex-col align-top lg:flex-row lg:space-x-8 lg:align-middle">
                    <div className="m-auto w-full lg:my-0">
                      <div className="  rounded border p-4">
                        ...
                        <button
                          className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-80 bg-zinc-900 text-zinc-50 shadow hover:bg-zinc-800/90 dark:bg-zinc-50 dark:text-zinc-900 dark:hover:bg-zinc-50/90 h-9 px-4 py-2 mt-4 w-full"
                          style={{
                            background: "#18181B",
                            color: "#FAFAFA",
                          }}
